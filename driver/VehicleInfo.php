...
if(isset($_POST['driverId']))
{
    ...
    if (mysqli_num_rows($check_user) > 0) 
    {
        if(isset($_POST['VehicleBrand']) || isset($_POST['vehicleModel']) || isset($_POST['numberPlate']) || isset($_POST['transportYear']))
        {
            ...
            {
                $update_vehicleInfo_query = "UPDATE Vehicleinfo SET vehicle_brand_name = '$Vehicle_brand', modal = '$vehicleModel', Number_plate = '$number_plat', transport_year = '$transport_year' WHERE driverId = '$id'";

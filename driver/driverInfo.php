...
if(isset($_POST['userId']))
{
    ...
    $check_user_query = "SELECT * FROM user WHERE id = '$userId'";
    ...
    if (mysqli_num_rows($check_user) > 0) 
    {
            ...
            {
                    $update_query = "UPDATE user SET firstname = '$firstname',lastname = '$lastname',dob = '$dob',email = '$email',user_status = '1' WHERE id='$userId'";
            ...
            if(isset($_FILES['profile']) && !empty($_FILES['profile']['tmp_name']))
            {
                ...
                if(!empty($image))
                {
                    ...
                    if (!file_exists($image_folder)) {
                        ...
                        $image_query = "UPDATE user SET photo = '$filepath' WHERE id = '$userId'";
